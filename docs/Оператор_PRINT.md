...
[Формат печати](В_печатном_представлении_PRINT.md#формат), задается одним из ключевых слов:
...
Ключевое слово. Если указывается, то форма показывается в режиме [предварительного просмотра](В_печатном_представлении_PRINT.md#интерактивное-печатное-представление). Этот режим используется по умолчанию, если другие режимы / форматы не заданы.
...
Ключевое слово. Если указывается, то форма выдает данные пользователю в режиме [сообщения](В_печатном_представлении_PRINT.md#интерактивное-печатное-представление).
