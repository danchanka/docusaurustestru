...
Также как и в [интерактивном представлении](В_интерактивном_представлении_SHOW_DIALOG.md), в интерактивных режимах печатного представления разработчик может задавать опции [управления потоком](В_интерактивном_представлении_SHOW_DIALOG.md#управление-потоком) и [расположения форм](В_интерактивном_представлении_SHOW_DIALOG.md#расположение-формы) (их поведение аналогично соответствующим опциям в операторе открытия формы в интерактивном представлении).
