...
Способ задания действия в этом типе взаимодействия полностью соответствует [способу задания](Обращение_из_внешней_системы.md#actiontype) действия при [обращении из внешней системы](Обращение_из_внешней_системы.md).
