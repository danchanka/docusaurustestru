...
Результирующим классом оператора выбора является общий предок его операндов ([встроенный](Встроенные_классы.md#commonparentclass) или [пользовательский](Пользовательские_классы.md#commonparentclass)).
